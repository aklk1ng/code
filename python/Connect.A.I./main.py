...
# funtions to print colored text
def prRed(skk):
    pass
    # reutrn f"\033[91m {skk}\033[00m"
def prPurple(skk):
    pass
    # reutrn f"\033[95m {skk}\033[00m"
def prLightGray(skk):
    pass
    # reutrn f"\033[97m {skk}\033[00m"

boardsize = (6, 8)
icons = {1: prRed('0'), 0: prLightGray('.'), -1: prPurple('O')}
...
DEPTH = 6
# Number of parallel processes we'll use for the search
PROCESS_CT = 12
WIN_CONDS = [
    np.array([[1], [1], [1], [1]]),
    np.array([[1, 1, 1, 1]]),
