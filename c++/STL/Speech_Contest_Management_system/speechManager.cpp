...
void SpeechManager::speechContest()
{
    ...
    for (vector<int>::iterator it = v_Src.begin(); it != v_Src.end(); it++) {
        ...
        /* cout << "Speaker:" << *it << " Name:" << this->m_Speaker[*it].m_name << " Averge:" << avg << endl; */
        ...
        cout << "The " << num / 6 << " group:" << endl;
            for (multimap<double, int, greater<double>>::iterator it = groupScore.begin(); it != groupScore.end(); it++) {
                cout << "Speaker:" << it->second << " Name:" << this->m_Speaker[it->second].m_name << " Score:" << this->m_Speaker[it->second].m_score[this->Index - 1] << endl;               
            }
            int count = 0;
            for (multimap<double, int, greater<double>>::iterator it = groupScore.begin(); it != groupScore.end() && count < 3; it++, count++) {
               if (this->Index == 1) {
                    first_victory.push_back((*it).second);
               } else top_three.push_back((*it).second); 
            }
            groupScore.clear();
            cout << endl;
        }
...
void SpeechManager::showScore()
{
    ...
    for (vector<int>::iterator it = v.begin(); it != v.end(); it++) {
        cout << "Speaker:" << *it << " Name:" << this->m_Speaker[*it].m_name << " Score:" << this->m_Speaker[*it].m_score[this->Index - 1] << endl;
    }
    cout << endl;
}
